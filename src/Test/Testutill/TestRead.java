...
class TestRead {
    ...
    private static final String TEST_FILE_PATH = "data/Kids/222/Product_encrypted.txt";
    private static final String TEST_DATA = "Apple,3.0\nbee,1.0\nT-shirt,5.0\n";
    private static final String ENCRYPTION_KEY = "1234567890123456"; // Replace with your actual key
    ...
    static void setup() throws Exception {
        ...
        // 确保加密密钥已设置
        if (System.getenv("ENCRYPTION_KEY") == null || System.getenv("ENCRYPTION_KEY").isEmpty()) {
