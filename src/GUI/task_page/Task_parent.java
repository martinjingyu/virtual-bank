...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        taskName.setBackground(new Color(-921103));
        gbc = new GridBagConstraints();
        gbc.gridx = 0;
        gbc.gridy = 0;
        gbc.weightx = 1.0;
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.HORIZONTAL;
        ShownPanel.add(taskName, gbc);
        name = new JLabel();
        Font nameFont = this.$$$getFont$$$("Arial Black", -1, 20, name.getFont());
        ...
        Salary = new JLabel();
        Font SalaryFont = this.$$$getFont$$$("Arial Black", -1, 16, Salary.getFont());
        ...
        Description.setText("Please sweep the floor in the living room and kitchen. ");
        ...
        Font buttonlabelFont = this.$$$getFont$$$("Arial Black", Font.BOLD, 16, buttonlabel.getFont());
